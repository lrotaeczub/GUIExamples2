...
public class ContactEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Rotaeche");

        jLabel3.setText("Cargo:");
        jLabel3.setToolTipText("");

        jTextField3.setText("Profesor");

        jLabel4.setText("Nickname:");

        jTextField4.setText("lrotaeczub");

        jLabel5.setText("Display Format:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "[Nickname]  First_Name + Last_Name", "Nickname" }));
